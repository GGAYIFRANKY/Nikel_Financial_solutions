        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">PAYMENTS  LIST</h6>
              
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-sm btn-neutral">ADD PAYMENT</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="status">AMOUNT PAID</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge badge-dot mr-4">
                        ...
                        <span class="status">100,000/=</span>
                      </span>
                    </td>
                    <td>
                      <span class="badge badge-dot mr-4">
                        <i class="bg-warning"></i>
                        <span class="status">150,000/=</span>
                      </span>
                    </td>
                    <td>
                      <span class="badge badge-dot mr-4">
